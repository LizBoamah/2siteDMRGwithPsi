...
if s == 1
    ...
    effective_H = reshape(effective_H, siz2, siz1);
...
elseif s == N-1
    ...
    siz1 = (size(effective_H, 1) * size(effective_H, 2)* size(effective_H, 3)* size(effective_H, 7));
    siz2 = (size(effective_H, 4) * size(effective_H, 5)* size(effective_H, 6)* size(effective_H, 8));
...
%     siz2 = (size(effective_H, 2) * size(effective_H, 4) * size(effective_H, 8) * size(effective_H, 6));
    ...
    siz1 = (size(effective_H, 1) * size(effective_H, 3) * size(effective_H, 3) * size(effective_H, 4));
    siz2 = (size(effective_H, 6) * size(effective_H, 5) * size(effective_H, 8) * size(effective_H, 7));
